...
{
    public partial class cdSchoolEditorUC : XtraUserControl
    {
        #region - Var -
        private static readonly log4net.ILog Logger = log4net.LogManager.GetLogger(typeof(cdSchoolEditorUC));
        Datasource.dsData.RuleDetailRow _elementRule = null;
        #endregion
        #region - Fun -
        public cdSchoolEditorUC(Datasource.dsData.RuleDetailRow RuleElement)
        {
            InitializeComponent();
        ...
        void LoadData()
        {
            ...
            System.Threading.ThreadPool.QueueUserWorkItem((o) => 
            {
                ...
                {
                    cdEdaraTableAdapter.Fill(dsData.cdEdara);
